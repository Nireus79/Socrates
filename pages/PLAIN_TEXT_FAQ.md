FREQUENTLY ASKED QUESTIONS - Socrates AI
...
A: Dialogue phase: 30 minutes to 2 hours (depending on project complexity)
...
A: Free: $0 (+ your Claude API costs, ~$1-5 per project)
...
A: Free tier is a full-featured trial. Pro tier: 30-day money-back guarantee. No credit card required for free tier.

Q: Do you offer student discounts?

A: Yes! 50% off Pro tier for students with .edu email. Contact support@socrates-ai.com

Q: What about open source projects?

A: Open source projects get free Pro tier access. Contact support@socrates-ai.com with proof (GitHub stars, PyPI downloads, etc.)

ACCOUNT AND DATA

Q: Where is my data stored?

A: Free/Pro tiers: AWS cloud (encrypted)
...
A: Yes! Full REST API available. See API Documentation at https://github.com/Nireus79/Socrates/blob/master/docs/API_REFERENCE.md
...
A: Review the specification. Update if needed. Regenerate. Rinse and repeat.
...
A: Download/copy code. Place in your project. Install dependencies. Run tests. Deploy.

PERFORMANCE AND SYSTEM

Q: How fast is code generation?

A: Questions: ~2-5 seconds each
Code generation: 10-30 seconds
...
A: Free tier: Community (Discord, GitHub)
...
A: Documentation at https://github.com/Nireus79/Socrates/blob/master/docs/
Discord Community at https://discord.gg/socrates
GitHub Issues at https://github.com/Nireus79/Socrates/issues
FAQ at hermessoft.wordpress.com/socrates-ai/faq
Email Support at support@socrates-ai.com

Q: How do I report a bug?

A: Check GitHub Issues (might be known)
Provide: Reproduction steps, error message, logs
File new issue with details
We respond within 24 hours (usually faster)

Q: How do I request a feature?

A: Check GitHub Discussions
Post your idea
Get community feedback
We prioritize based on interest

Q: Is there a Discord community?

A: Yes! Join 100+ developers at https://discord.gg/socrates
...
A: No known breaches. Regular security audits. Vulnerability disclosure program. SOC 2 certification (coming Q2 2026).

MISCELLANEOUS

Q: What's the open source license?

A: MIT License. You can use, modify, and distribute freely. See License at https://github.com/Nireus79/Socrates/blob/master/LICENSE
...
See Contributing Guide at https://github.com/Nireus79/Socrates/blob/master/CONTRIBUTING.md

Q: What's the roadmap?

A: v1.4 (Q1 2026): GitHub/Jira integration
v1.5 (Q2 2026): VS Code extension, offline models
v2.0 (Q3 2026): Multi-service architecture
Full Roadmap at https://github.com/Nireus79/Socrates/blob/master/ROADMAP.md

Q: Can I sponsor Socrates?

A: Yes! Support on GitHub Sponsors at https://github.com/sponsors/Nireus79
...
A: Follow on GitHub
Join Discord
Subscribe to newsletter: support@socrates-ai.com
Check Blog at https://github.com/Nireus79/Socrates/blob/master/BLOG.md

STILL HAVE QUESTIONS?

Documentation:
Browse Full Docs at https://github.com/Nireus79/Socrates/blob/master/docs/

Community:
Join Discord at https://discord.gg/socrates

Direct Support:
Email Us at support@socrates-ai.com

Report Issue:
GitHub Issues at https://github.com/Nireus79/Socrates/issues

Didn't find your answer? Ask us!
support@socrates-ai.com or Discord at https://discord.gg/socrates
