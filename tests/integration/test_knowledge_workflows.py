...
class TestKnowledgeEntryCreation:
    ...
    async def test_create_knowledge_entry_success(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_create_knowledge_with_metadata(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_create_knowledge_minimal_info(self, client: AsyncClient, authenticated_headers, sample_project):
...
class TestKnowledgeRetrieval:
    ...
    async def test_list_project_knowledge(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entries):
    ...
    async def test_get_knowledge_entry_details(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_list_knowledge_pagination(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_list_knowledge_sorted_by_date(self, client: AsyncClient, authenticated_headers, sample_project):
...
class TestKnowledgeCategorization:
    ...
    async def test_filter_knowledge_by_category(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_filter_knowledge_by_tag(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_auto_categorization_on_create(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_list_all_categories(self, client: AsyncClient, authenticated_headers, sample_project):
...
class TestKnowledgeSearch:
    ...
    async def test_search_knowledge_by_title(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_search_knowledge_by_content(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_search_full_text(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_search_returns_relevance_ranked(self, client: AsyncClient, authenticated_headers, sample_project):
...
class TestKnowledgeUpdate:
    ...
    async def test_update_knowledge_title(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_update_knowledge_content(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_update_knowledge_tags(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_update_knowledge_category(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
...
class TestKnowledgeLinking:
    ...
    async def test_link_knowledge_entries(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry, related_entry):
    ...
    async def test_list_linked_knowledge(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_unlink_knowledge_entries(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry, related_entry):
...
class TestKnowledgeDeletion:
    ...
    async def test_delete_knowledge_entry(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_delete_knowledge_cascade_deletes_links(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry, related_entry):
...
class TestKnowledgeExport:
    ...
    async def test_export_knowledge_json(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_export_knowledge_markdown(self, client: AsyncClient, authenticated_headers, sample_project):
    ...
    async def test_export_knowledge_with_category_filter(self, client: AsyncClient, authenticated_headers, sample_project):
...
class TestKnowledgeVersioning:
    ...
    async def test_knowledge_has_version_history(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
    ...
    async def test_restore_previous_knowledge_version(self, client: AsyncClient, authenticated_headers, sample_project, knowledge_entry):
