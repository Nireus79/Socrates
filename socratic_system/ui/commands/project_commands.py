...
class ProjectCreateCommand(BaseCommand):
    ...
    def execute(self, args: List[str], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if result['status'] == 'success':
            ...
            print(f"  • Use /continue to start the Socratic session")
            print(f"  • Use /collab add <username> to invite collaborators")
            print(f"  • Use /docs import <path> to import documents")
            ...
            if 0 <= choice < len(all_projects):
                ...
                if result['status'] == 'success':
                    ...
                    if getattr(project, 'is_archived', False):
                        ...
                        print(f"{Fore.YELLOW}Note: This project is archived. Some features may be limited.{Style.RESET_ALL}")
                    else:
...
class ProjectListCommand(BaseCommand):
    ...
    def execute(self, args: List[str], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for project in result['projects']:
            ...
            print(f"{status_color}{status_indicator} {project['name']:30} ({project['phase']:15}) - {project['updated_at']}")
